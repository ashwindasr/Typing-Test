...
function TypeText(props) {
    ...
    // let i = 0;
    // let firstSplit = props.text.split(" ");
    // let firstMap = firstSplit.map((item) => (
    //         item.split("").map((secondItem) =>
    //                 <div id={"typeText" + i++}>{secondItem}</div>,
    //
    //         )
    //
    //     // <div>{item}</div>
    ...
    render() {
        return (
            <Container>
                ...
                <Row className="speed-div"><div id="speed"></div></Row>
                <Row className="accuracy-div"><div id="accuracy"></div></Row>
            </Container>
        );
    }
